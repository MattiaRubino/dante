"""B10-A: repair Actual scoped-owner creation order.

Revision ID: 20260925_72
Revises: 20260925_71

The CP6 scoped-address owner-binding trigger is immediate: an Actual owner row
must exist before its scoped_address row can be admitted. Actual creation
completeness is separately enforced by the deferred owner-completeness trigger,
so the bounded transactional order is Actual -> ScopedAddress -> MaterialState
and current/history companions.
"""
...
revision: str = "20260925_72"
down_revision: str | None = "20260925_71"
...
def downgrade() -> None:
    raise RuntimeError(
        "B10-A Actual owner-creation-order repair downgrade is intentionally refused; "
