"""Provider-neutral contracts for DANTE durable outbound email."""
...
class EmailIntentSpec:
    """Frozen provider-neutral semantics derived from one typed email command."""
