"""Transactional PostgreSQL outbox for DANTE Auth/security email."""
...
from dante.auth.email_render import email_intent_spec
...
class DurableEmailOutbox:
    """Write intents atomically, claim with SKIP LOCKED and preserve uncertain outcomes."""
    ...
    async def stage(
        ...
        *,
        ...
        """Write one intent in the caller-owned transaction; Noop remains non-persistent."""
