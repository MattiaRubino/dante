"""Last-mile provider adapters for the shared DANTE Email Platform."""
...
class SesEmailProvider(EmailProviderPort):
    ...
    def __init__(self, *, settings: EmailPlatformSettings) -> None:
...
class SmtpEmailProvider(EmailProviderPort):
    ...
    def _send_sync(self, message: ProviderMessage) -> None:
        ...
        security = _enum_value(self._settings.smtp_security)
