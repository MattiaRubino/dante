...
/**
 * Resolves the accepted Home prototype backdrop for dev, tests and builds.
 * Keeping this as one plugin prevents Vitest from drifting away from the
 * production asset identity and keeps the prototype verification centralized.
 */
export function dayRibbonBackdropPlugin(): Plugin {
