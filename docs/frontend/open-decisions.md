...
Resolved AppShell debt is not retained as an open item. The deprecated `shell.review.legacy` decision was closed on 2026-09-02 by removing the disabled global Review affordance and its fake badge without introducing a replacement global workflow.
