...
- [`multi-actor-collaboration-research-2026-08.md`](multi-actor-collaboration-research-2026-08.md) — independent external research pass spanning foundational CSCW, coordination/common-ground theory, calendars/privacy, family mental load, work/shift fairness, caregiving/healthcare, external participants, shared expenses, current product patterns, GDPR/privacy-by-design and authorization evidence. It challenges and expands the simulation without promoting findings directly into architecture.
- [`multi-actor-collaboration-research-stress-domains-2026-08.md`](multi-actor-collaboration-research-stress-domains-2026-08.md) — targeted deep-research appendix stress-testing adversarial relationship exits, children/adolescent agency, accessibility and low digital literacy, and AI-mediated multi-party privacy/leakage. It extends the evidence base without changing accepted product or architecture decisions.
