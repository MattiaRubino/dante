...
- **Status:** APPROVED EXECUTION PLAN — B06-A active
- **Date:** 2026-09-21
...
|---|---|---|
| **B06-A — Routine source core** | Self-owned Routine identity, source title/lifecycle (`active`, `paused`, `ended`), atomic Life Area and source Tag integration, immutable create/lifecycle receipts and public source reads. | PostgreSQL self scope/ACL/CAS/replay/lifecycle proof, Dictionary/catalog/mapping and Routine API/client proof. |
